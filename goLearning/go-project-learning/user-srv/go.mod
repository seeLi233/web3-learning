...
require (
	...
	github.com/go-project-learning/project/gateway-api v0.0.0-00010101000000-000000000000
...
replace (
	github.com/go-project-learning/project/common => ../common
	github.com/go-project-learning/project/gateway-api => ../gateway-api
)
